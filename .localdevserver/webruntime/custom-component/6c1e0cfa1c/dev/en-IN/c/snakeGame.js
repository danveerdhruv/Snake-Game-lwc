Webruntime.define('lwc/snakeGame', ['lwc'], function (lwc) { 'use strict';
    ...
    lwc.registerDecorators(SnakeGame, {
      ...
      fields: ["score", "blockSize", "renderComplete", "xSpeed", "ySpeed", "xHead", "yHead", "xMax", "yMax", "score", "tail"]
    });
